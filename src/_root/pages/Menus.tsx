...
const Menus = () => {
  ...
  return (
    <>
    <div className='flex flex-col items-center min-h-screen'> {/* Ensures full vertical and horizontal centering */}
      <div>
        <h2 className="text-3xl text-center font-bold font-garamond tracking-widest text-cream1 sm:text-[40px]">
          Our Menus
        </h2>
      </div>
